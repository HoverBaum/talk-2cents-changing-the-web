...
import WebMInit from './components/WebMInit'
...
import TrainWaitingImage from './img/train-waiting.jpg'
...
- Based on the interledger protocol; send small amounts of money.
...
- A W3C specified protocol (draft) that many can contribute to.
...
<SlideHeadline sectionTitle="Web Monitization">In Action</SlideHeadline>

This slide-deck is Web Monetized. Below you can check the state and how much you have already contributed to these slides.
...
<SlideHeadline sectionTitle="Interledger">www for money</SlideHeadline>
...
<Credit creditLink="https://interledger.org/" credit="Interledger.org" />
...
<SlideHeadline sectionTitle="Bottom Line"></SlideHeadline>
...
<BackgroundImage
  src={TrainWaitingImage}
  blur
  creditLink="https://unsplash.com/photos/QoulhuQp3gU"
  credit="@markuswinkler on Unsplash"
/>

<Impact>Waiting for the hype-🚂</Impact>

---

<SlideHeadline sectionTitle="Closing words"></SlideHeadline>

The move from platforms to protocols has been going for years. Many, recent developments are fueling it. Still, it may be decades before we see the realization of this brave new world. As consultants at the forefront of digitalization we should keep a look out for what is to come.

---

<SlideHeadline sectionTitle="Links">Further reading</SlideHeadline>

- https://webmonetization.org/
- https://interledger.org/
- https://activitypub.rocks/
- https://joinmastodon.org/
- 30 min. on Web Monetization Talk by Stefan Thomas https://www.youtube.com/watch?v=ZckA-__R2sc
...
<ClosingSlide
  title="🤑 How I earned 2 cents"
  author="Hendrik Wallbaum"
  repoLink="https://github.com/HoverBaum/talk-2cents-changing-the-web"
/>

<Credit
  creditLink="https://talks.hoverbaum.net/"
  credit="talks.hoverbaum.net"
/>
